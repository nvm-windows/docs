...
As of v2.0.0, settings and preferences are stored in the registry under user keys. These can be modified with the [`nvm config`](../command/nvm/config) command. See [Basic Configuration](../cfg/core) for the full preference list.
