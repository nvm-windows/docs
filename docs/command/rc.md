...
|----------|----------|-------------|
| `[<version>]` | No | [Version specifier](../introduction/version-specifiers) to resolve and write. If omitted, uses the current active version. Pinning file formats: [Version Selectors](../introduction/version-selectors). |
