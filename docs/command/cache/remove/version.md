...
|----------|----------|-------------|
| `[version ...]` | No* | [Version specifiers](../../../introduction/version-resolution#version-specifiers) to remove. With `--all`, each token is a major or major.minor prefix. *Required unless `--prompt` is used. |
