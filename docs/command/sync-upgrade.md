...
| Policy | Upgrade execution blocked when [`disable_upgrade=true`](../cfg/registry#available-registry-keys) _(Certified Builds / machine policy)_; check-only still allowed |
